...
public class AdminDashboard extends javax.swing.JFrame implements DashboardOperation{
    ...
    private UserProfile loggedUser = Auth.getLoggedUser();
    private byte[] profilePicture = loggedUser.getProfilePicture();
    ...
    public AdminDashboard(Admin admin) {
        ...
        if (loggedUser != null) {
            ...
            JOptionPane.showMessageDialog(this, "No user is currently logged in. Please log in to access the admin dashboard.");
        }
    }
